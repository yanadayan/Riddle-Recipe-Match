...
public class Level5OrderScene implements LevelScene{
    ...
    public Level5OrderScene(SceneManager sceneManager) {
        Pane root = new Pane();
        MusicManager.play("order", false, 0.6);
        // Responsive GIF background
        URL url = getClass().getResource("/resources/level5OrderScene.gif");
        if (url == null) throw new RuntimeException("level5OrderScene.gif not found! Check path and spelling.");
        ...
        matchNowBtn.setOnAction(e -> sceneManager.showGameSceneForLevel(5));
