...
// MODIFY: add implements LevelScene
public class Level1OrderScene implements LevelScene {
    ...
    public Level1OrderScene(SceneManager sceneManager) {
        Pane root = new Pane();
        MusicManager.stop();
        MusicManager.play("order", false, 0.6);
        // Responsive GIF background
        URL url = getClass().getResource("/resources/Level1orderscene1f.gif");
        if (url == null) throw new RuntimeException("Level1orderscene1f.gif not found! Check path and spelling.");
        ...
        matchNowBtn.setOnAction(e -> sceneManager.showGameSceneForLevel(1));
