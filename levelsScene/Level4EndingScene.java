...
public class Level4EndingScene  implements LevelScene{
    ...
    public Level4EndingScene(SceneManager sceneManager) {
        Pane root = new Pane();
        MusicManager.play("order", false, 0.6);
        // Responsive GIF background
        String gifPath = "/resources/level4EndingScene.gif";
        ImageView endingGif;
        try {
        ...
        nextButton.setOnAction(e -> sceneManager.showUnlockSceneForLevel(5));
