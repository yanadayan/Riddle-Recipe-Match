...
public class Level3OrderScene implements LevelScene {
    ...
    public Level3OrderScene(SceneManager sceneManager) {
        Pane root = new Pane();
        MusicManager.play("order", false, 0.6);
        // Responsive GIF background
        URL url = getClass().getResource("/resources/level3OrderScene.gif");
        if (url == null) throw new RuntimeException("level3OrderScene.gif not found! Check path and spelling.");
        ...
        matchNowBtn.setOnAction(e -> sceneManager.showGameSceneForLevel(3));
