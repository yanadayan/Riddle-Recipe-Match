...
public class Level4OrderScene implements LevelScene{
    ...
    public Level4OrderScene(SceneManager sceneManager) {
        Pane root = new Pane();
        MusicManager.play("order", false, 0.6);
        // Responsive GIF background
        URL url = getClass().getResource("/resources/level4OrderScene.gif");
        if (url == null) throw new RuntimeException("level4OrderScene.gif not found! Check path and spelling.");
        ...
        matchNowBtn.setOnAction(e -> sceneManager.showGameSceneForLevel(4));
