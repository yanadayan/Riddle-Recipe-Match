...
public class Level2EndingScene implements LevelScene {
    ...
    public Level2EndingScene(SceneManager sceneManager) {
        Pane root = new Pane();
        MusicManager.play("order", false, 0.6);
        // Responsive GIF background
        String gifPath = "/resources/level2EndingScene.gif";
        ImageView endingGif;
        try {
        ...
        nextButton.setOnAction(e -> sceneManager.showUnlockSceneForLevel(3));
