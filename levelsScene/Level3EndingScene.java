...
public class Level3EndingScene implements LevelScene {
    ...
    public Level3EndingScene(SceneManager sceneManager) {
        Pane root = new Pane();
        MusicManager.play("order", false, 0.6);
        // Responsive GIF background
        String gifPath = "/resources/level3EndingScene.gif";
        ImageView endingGif;
        try {
        ...
        nextButton.setOnAction(e -> sceneManager.showUnlockSceneForLevel(4));
